...
namespace Inventory.Domain.Common.Factories.Rule
{
    public static class StockReceiptRuleFactory
    {
        ...
        {
            return new StringMaxLength(value, 50, StockReceipField.Supplier, StockReceipMessages.SupplierMaxLengthExceeded);
        }

        public static IBusinessRule NameNotEmpty(string value)
        {
            return new StringNotEmpty(value, StockReceipField.Supplier, StockReceipMessages.SupplierMustNotBeEmpty);
        }
    }
}