...
{
    public sealed class GetByIdQHandler : IRequestHandler<GetByIdQuery, FoodRecipeResponse>
    {
        ...
        public async Task<FoodRecipeResponse> Handle(GetByIdQuery query, CancellationToken token)
        {
