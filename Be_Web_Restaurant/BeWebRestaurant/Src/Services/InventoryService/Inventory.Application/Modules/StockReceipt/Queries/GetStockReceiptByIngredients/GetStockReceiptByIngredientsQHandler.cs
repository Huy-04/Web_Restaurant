...
{
    public sealed class GetStockReceiptByIngredientsQHandler : IRequestHandler<GetStockReceiptByIngredientsQuery, IEnumerable<StockReceiptResponse>>
    {
        private readonly IUnitOfWork _uow;

        public GetStockReceiptByIngredientsQHandler(IUnitOfWork uow)
        {
            _uow = uow;
        }

        public async Task<IEnumerable<StockReceiptResponse>> Handle(GetStockReceiptByIngredientsQuery query, CancellationToken token)
        {
